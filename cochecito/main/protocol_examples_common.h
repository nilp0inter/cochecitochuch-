...
#ifdef CONFIG_COCHECITO_CONNECT_ETHERNET
#define COCHECITO_INTERFACE get_example_netif()
#endif

#ifdef CONFIG_COCHECITO_CONNECT_WIFI
#define COCHECITO_INTERFACE get_example_netif()
#endif

#if !defined (CONFIG_COCHECITO_CONNECT_ETHERNET) && !defined (CONFIG_COCHECITO_CONNECT_WIFI)
// This is useful for some tests which do not need a network connection
#define COCHECITO_INTERFACE NULL
#endif
...
#endif // CONFIG_COCHECITO_CONNECT_ETHERNET
